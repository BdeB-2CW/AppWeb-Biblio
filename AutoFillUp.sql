...
insert into Livres (ID, Titre, Auteur, DateParution, NbCopies, NbDisponible, MaisonEdition, ISBN, Cout, Description, Photo) VALUES (ID, 'L\'étranger', 'Albert Camus', 2001, 3, 3, 'folio', 'ACLE005', 12.99, ' Récit intérieur de Meursault, employé de bureau anonyme pour les autres et pour lui-même, qui tue finalement de cinq balles un Algérien sur la plage de Tipaza à Alger.', '\/Images\/Livres\/AlbertCamus\/lEtanger.jpg'); 
...
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Michelle', 'Horton', '5142994742','MichelleHorton@gmail.com', 'abc123', 5, 0, 0, '\/Images\/Profil\/1.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Maria', 'Duke', '4162438749','MariaDuke@gmail.com', 'abc123', 5, 0, 0, '\/Images\/Profil\/2.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'David', 'Day', '4169319935','DavidDay@gmail.com', 'abc123', 5, 1, 0, '\/Images\/Profil\/3.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Augustine', 'Chambers', '9054803579','AugustineChambers@gmail.com', 'abc123', 5, 1, 0, '\/Images\/Profil\/4.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Michael', 'Alexander', '7809999518','MichaelAlexander@gmail.com', 'abc123', 5, 1, 0, '\/Images\/Profil\/5.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Charles ', 'Thomas', '6044525679','CharlesThomas@gmail.com', 'abc123', 5, 3, 0, '\/Images\/Profil\/6.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Wajd', 'Horton', '5142994744','WajdHorton@gmail.com', 'abc123', 5, 1, 0, '\/Images\/Profil\/7.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Raniya', 'Samaha', '6049287185','RaniyaSamaha@gmail.com', 'abc123', 5, 5, 0, '\/Images\/Profil\/8.png'); 
insert into Utilisateurs (ID, Nom, Prenom ,Telephone, Email, Password, MaxPret, NbPret, Droit_id, Photo) VALUES (ID, 'Abdul', 'Naifeh', '7056982151','AbdulNaifeh@gmail.com', 'abc123', 5, 1, 0, '\/Images\/Profil\/9.png'); 
